...
public class Producto {
    ...
    public Producto getProducto(int identificacion) throws SQLException {
    ...
    public boolean borrarProducto(int identificacion) {
    ...
    public String toString() {
        return "Producto{" + "identificacion=" + identificacion + ", nombre=" + nombre + ", apellido=" + apellido + ", genero=" + genero + ", tipoIdentificacion=" + tipoIdentificacion + ", telefono=" + telefono + ", direccion=" + direccion + ", correo=" + correo + '}';
    }
}
